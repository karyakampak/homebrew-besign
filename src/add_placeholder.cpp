...
std::unordered_map<std::string, std::string> AddPlaceHolder::addPlaceholder(const char* pdf_path, const char* image_path, int page, int visibility, float x, float y, float width, float height, int isSeal) {
    ...
    if(isSeal){
        signature_object_added = adseal.add_sealdict(pdfContent, image_path, page, visibility, x, y, width, height, page_reference, pdf_component, signature_reference);
    } else{
        signature_object_added = adsig.add_signaturedict(pdfContent, image_path, page, visibility, x, y, width, height, page_reference, pdf_component, signature_reference);
    }
